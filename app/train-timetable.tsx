...
const styles = StyleSheet.create({
  ...
  columnHeader: { fontSize: 12, fontWeight: "600", color: "#475569", width: 50, textAlign: "center" },
  ...
  stationCode: { fontSize: 12, fontWeight: "600", color: "#2563EB", width: 50, textAlign: "center" },
